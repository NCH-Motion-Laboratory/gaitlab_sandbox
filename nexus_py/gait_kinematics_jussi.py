...
NormGraphTitle = vicon.GetTrialName()[1]
...
# how many strikes on each size
lenLFS = len(LFStrike)
lenRFS = len(RFStrike)

# 2 strikes is one complete gait cycle
if lenLFS and lenRFS >= 2:
    ...
    # ankle rotation
    RGC1LAnkZ = RAnkA[0][0][2][RGC1Start:RGC1End]
    ...
    plt.subplot(4, 3, 12)
    plot11 = plt.plot(tn, Norm_LAnkleZ, '#DC143C', Norm_RAnkleZ, '#6495ED')
    #sns.despine(fig=None, ax=None, top=True, right=True, left=False, bottom=False, trim=False)
