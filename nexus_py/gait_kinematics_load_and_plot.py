...
# load trial data from .mat file and plot
# for development of plotting code (does not need Nexus)

trialdatafn = '2015_2_25_seur_RK06.p'
...
modeldata = pickle.load(open(trialdatafn,'rb'))

SubjectName = modeldata['SubjectName']
TrialName = modeldata['TrialName']
LPelvisA = modeldata['LPelvisA']
RPelvisA = modeldata['RPelvisA']
LHipA = modeldata['LHipA']
RHipA = modeldata['RHipA']
LKneeA = modeldata['LKneeA']
RKneeA = modeldata['RKneeA']
LAnkA = modeldata['LAnkA']
RAnkA = modeldata['RAnkA']
LFootPro = modeldata['LFootPro']
RFootPro = modeldata['RFootPro']
LFStrike = modeldata['LFStrike']
RFStrike = modeldata['RFStrike']
lenLFS = modeldata['lenLFS']
lenRFS = modeldata['lenRFS']

# If the data contain events to normalise create the file name and graph title
NormTrialName = TrialName + "_Normalized Kinematics.pdf"
NormGraphTitle = "Kinematics for " + TrialName + " Normalized to Gait Cycle"
