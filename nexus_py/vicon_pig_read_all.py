...
plot1 = plt.plot(tn, KinematicsAll['NormLPelvisAnglesX'], '#DC143C', KinematicsAll['NormRPelvisAnglesX'], '#6495ED')
...
plt.subplot(4, 3, 2)
plot2 = plt.plot(tn, KinematicsAll['NormLPelvisAnglesY'], '#DC143C', KinematicsAll['NormRPelvisAnglesY'], '#6495ED')
...
plt.subplot(4, 3, 3)
plot3 = plt.plot(tn, KinematicsAll['NormLPelvisAnglesZ'], '#DC143C', KinematicsAll['NormRPelvisAnglesZ'], '#6495ED')
...
plt.subplot(4, 3, 4)
plot4 = plt.plot(tn, KinematicsAll['NormLHipAnglesX'], '#DC143C', KinematicsAll['NormRHipAnglesX'], '#6495ED')
...
plt.subplot(4, 3, 5)
plot5 = plt.plot(tn, KinematicsAll['NormLHipAnglesY'], '#DC143C', KinematicsAll['NormRHipAnglesY'], '#6495ED')
...
plt.subplot(4, 3, 6)
plot6 = plt.plot(tn, KinematicsAll['NormLHipAnglesZ'], '#DC143C', KinematicsAll['NormRHipAnglesZ'], '#6495ED')
...
plt.subplot(4, 3, 7)
plot7 = plt.plot(tn, KinematicsAll['NormLKneeAnglesX'], '#DC143C', KinematicsAll['NormRKneeAnglesX'], '#6495ED')
...
plt.subplot(4, 3, 8)
plot8 = plt.plot(tn, KinematicsAll['NormLKneeAnglesY'], '#DC143C', KinematicsAll['NormRKneeAnglesY'], '#6495ED')
...
plt.subplot(4, 3, 9)
plot9 = plt.plot(tn, KinematicsAll['NormLKneeAnglesZ'], '#DC143C', KinematicsAll['NormRKneeAnglesZ'], '#6495ED')
...
plt.subplot(4, 3, 10)
plot10 = plt.plot(tn, KinematicsAll['NormLAnkleAnglesX'], '#DC143C', KinematicsAll['NormRAnkleAnglesX'], '#6495ED')
...
plt.subplot(4, 3, 11)
plot11 = plt.plot(tn, KinematicsAll['NormLFootProgressAnglesZ'], '#DC143C', KinematicsAll['NormRFootProgressAnglesZ'], '#6495ED')
...
plt.subplot(4, 3, 12)
plot11 = plt.plot(tn, KinematicsAll['NormLAnkleAnglesZ'], '#DC143C', KinematicsAll['NormRAnkleAnglesZ'], '#6495ED')
