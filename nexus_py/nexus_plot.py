...
class nexus_plotter():
    ...
    #layout, plotvars, plotheightratios=None, maintitlestr='Plot for ', makepdf=False, pdftitlestr=None,
#                onesided_kinematics=False, annotate_disconnected=True, annotate_reused=True):
    ...
    def __init__(self, layout, plotvars):
        ...
        self.plotheightratios = plotheightratios
        self.maintitlestr = maintitlestr
        self.makepdf = makepdf
        self.pdftitlestr = pdftitlestr
        self.onesided_kinematics = onesided_kinematics
    ...
    def open_trial(self, trialpath=None):
        """ Read specified trial, or the one opened in Nexus. """
        ...
        self.emg = nexus_getdata.nexus_emg(mapping_changes=emg_mapping)
    ...
    def plot_trial(self, plotheightratios=None, maintitlestr='Plot for ',
                 makepdf=False, pdftitlestr=None, onesided_kinematics=False):

        """ Plot active trial (call open_trial first). If a plot is already 
