...
matname = '2015_2_25_seur_RK06.mat'
...
data = scipy.io.loadmat(matname)

SubjectName = data['SubjectName']
TrialName = data['TrialName']
LPelvisA = data['LPelvisA']
RPelvisA = data['RPelvisA']
LHipA = data['LHipA']
RHipA = data['RHipA']
LKneeA = data['LKneeA']
RKneeA = data['RKneeA']
LAnkA = data['LAnkA']
RAnkA = data['RAnkA']
LFootPro = data['LFootPro']
RFootPro = data['RFootPro']
LFStrike = data['LFStrike']
RFStrike = data['RFStrike']
lenLFS = data['lenLFS']
lenRFS = data['lenRFS']
